...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__h__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__router__ = __webpack_require__(82);
...
var Duplex = __webpack_require__(43).Duplex;
var bind = __webpack_require__(6);
var uuid = __webpack_require__(94);
var debug = __webpack_require__(33)('socket.io-stream:iostream');
...
var spawn = __webpack_require__(104).spawn;
...
var _PlaylistButton = __webpack_require__(59);

var _PlaylistButton2 = _interopRequireDefault(_PlaylistButton);

var _newPlaylistModal = __webpack_require__(61);

var _newPlaylistModal2 = _interopRequireDefault(_newPlaylistModal);

var _confirmDeleteSavedPlaylist = __webpack_require__(60);

var _confirmDeleteSavedPlaylist2 = _interopRequireDefault(_confirmDeleteSavedPlaylist);

var _submitKeysModal = __webpack_require__(62);

var _submitKeysModal2 = _interopRequireDefault(_submitKeysModal);

var _GoToPlaylist = __webpack_require__(58);
...
var Layout = function Layout(_ref, children) {
  ...
  var openNewPlModal = actions.openNewPlModal,
      ...
      confirmDeletePl = actions.confirmDeletePl;
  ...
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)(
      ...
      (0, _hyperapp.h)(
        'span',
        null,
        (0, _hyperapp.h)('img', { src: '/Users/john/Development/my-stuff/musichacker/client/dist/icons/' + state.currentIcon })
      ),
      'music hacker'
    ),
    (0, _hyperapp.h)(
    ...
    showingModal === 'newplaylist' && (0, _hyperapp.h)(_newPlaylistModal2.default, {
      state: state,
      actions: actions }),
    showingModal === 'confirmdelete' && (0, _hyperapp.h)(_confirmDeleteSavedPlaylist2.default, {
      state: state,
      actions: actions }),
    showingModal === 'submitkeys' && (0, _hyperapp.h)(_submitKeysModal2.default, {
      state: state,
      actions: actions }),
...
const PerMessageDeflate = __webpack_require__(9);
const isValidUTF8 = __webpack_require__(101);
const bufferUtil = __webpack_require__(14);
const ErrorCodes = __webpack_require__(35);
...
const PerMessageDeflate = __webpack_require__(9);
const EventTarget = __webpack_require__(100);
const Extensions = __webpack_require__(36);
const constants = __webpack_require__(15);
const Receiver = __webpack_require__(37);
const Sender = __webpack_require__(38);
...
var _playlists = __webpack_require__(55);

var _playlists2 = _interopRequireDefault(_playlists);

var _currentPlaylist = __webpack_require__(53);

var _currentPlaylist2 = _interopRequireDefault(_currentPlaylist);

var _UI = __webpack_require__(52);

var _UI2 = _interopRequireDefault(_UI);

var _videoSuggestions = __webpack_require__(57);

var _videoSuggestions2 = _interopRequireDefault(_videoSuggestions);

var _streaming = __webpack_require__(56);

var _streaming2 = _interopRequireDefault(_streaming);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = Object.assign({}, _init2.default, _playlists2.default, _currentPlaylist2.default, _UI2.default, _videoSuggestions2.default, _streaming2.default, {
  handleDlLink: function handleDlLink(state, actions, data) {
...
var _updatedTracksWithDl = __webpack_require__(22);
...
var _playlistEditor = __webpack_require__(66);
...
var views = module.exports = {
  '/': _home2.default,
  'index.html': _home2.default,
  '/playlist/:id': _playlistEditor2.default,
...
module.exports = {
  ...
  possiblyUpdateCurrent: function possiblyUpdateCurrent(state, actions, incomingPl) {
    if (JSON.stringify(state.currentPlaylist) !== JSON.stringify(incomingPl)) {
...
var _socket3 = __webpack_require__(89);
...
module.exports = {
  ...
  deleteSavedPlaylist: function deleteSavedPlaylist(state, actions, pl) {
    ...
    var newPlaylists = state.playlists.filter(function (playlist) {
...
module.exports = {
  ...
  suggestVids: function suggestVids(state, actions) {
    ...
    return {
      suggestRequest: setTimeout(function () {
        ...
        state.socket.emit('suggest', { suggestText: suggestText }, function (suggestions) {
  ...
  vidClick: function vidClick(state, actions, vid) {
    ...
    var generateNewTracks = function generateNewTracks(vid) {
      return [vid].concat(state.currentPlaylist.tracks || []);
    };
    ...
    updateServerTracks(currentPlaylistId, beforeDL, function (res) {
      ...
      window.getAudio(vid.url).then(function (file) {
...
var GoToPlaylist = function GoToPlaylist(_ref, children) {
  var state = _ref.state,
      actions = _ref.actions;
...
var PlaylistButton = function PlaylistButton(_ref, children) {
  var onSelect = _ref.onSelect,
      ...
      confirmDeletePl = _ref.confirmDeletePl;

  var onselectplaylist = function onselectplaylist() {
  ...
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)(
      'div',
      { 'class': 'x small', onclick: function onclick() {
          return confirmDeletePl(pl);
        } },
      'x'
    ),
    (0, _hyperapp.h)(
      'li',
      { onmousedown: onselectplaylist, 'class': selected ? 'selected' : '' },
      (0, _hyperapp.h)(
        'h3',
        null,
        pl.title
...
var ConfirmDeleteSavedPlaylist = function ConfirmDeleteSavedPlaylist(_ref, children) {
  var state = _ref.state,
      actions = _ref.actions;

  return (0, _hyperapp.h)(
    "div",
    { "class": "modal", id: "deleteplaylist" },
    (0, _hyperapp.h)(
      "a",
      { "class": "x", onclick: actions.hideModals },
      "x"
...
var YoutubeSearcher = function YoutubeSearcher(_ref, children) {
  ...
  return (0, _hyperapp.h)(
    ...
    state.suggestions && (0, _hyperapp.h)(
      "div",
      { id: "vidSuggestions" },
      state.suggestions.map(function (vid) {
        return (0, _hyperapp.h)(
          "div",
          { onclick: function onclick(e) {
              e.preventDefault();actions.vidClick(vid);
            } },
...
var _views = __webpack_require__(50);

var _views2 = _interopRequireDefault(_views);

var _changingIcon = __webpack_require__(47);

var _changingIcon2 = _interopRequireDefault(_changingIcon);

var _cachePages = __webpack_require__(46);

var _cachePages2 = _interopRequireDefault(_cachePages);

var _modalManager = __webpack_require__(49);

var _modalManager2 = _interopRequireDefault(_modalManager);

var _keyManager = __webpack_require__(48);
...
(0, _hyperapp.app)({
  ...
  plugins: [_hyperapp.Router, _changingIcon2.default, _cachePages2.default, _modalManager2.default, _keyManager2.default]
});
...
var _youtubeSearcher = __webpack_require__(63);
        ...
        state.currentPlaylist.tracks && state.currentPlaylist.tracks.map && state.currentPlaylist.tracks.map(function (track, i) {
          return (0, _hyperapp.h)(
            ...
            (0, _hyperapp.h)(
              ...
              (0, _hyperapp.h)('img', {
                ...
                onmousedown: function onmousedown() {
                  if (track.dl) actions.requestStream(track);
                },
            ...
            (0, _hyperapp.h)(
              'td',
              null,
              track.dl ? (0, _hyperapp.h)(
                'a',
                {
                  // href={'/dl/song/' + track.dl.replace(/''/g, "'")}
                  onclick: function onclick() {
                    window.openItem('/' + track.dl);
                  }
                },
                (0, _hyperapp.h)('img', { width: '50px', src: '/Users/john/Development/my-stuff/musichacker/client/dist/download.gif' })
...
var IOStream = __webpack_require__(13);
var BlobReadStream = __webpack_require__(90);
...
var debug = __webpack_require__(33)('socket.io-stream:socket');
...
const WebSocket = __webpack_require__(39);

WebSocket.Server = __webpack_require__(102);
WebSocket.Receiver = __webpack_require__(37);
WebSocket.Sender = __webpack_require__(38);
